...
public class Tower extends JPanel implements MouseListener, MouseMotionListener {
	...
	public Tower(){
		...
		poleA.setBounds(105,630, 100, 30);
		poleA.setFont(pole);
		this.add(poleA);
		poleB.setForeground(Color.white);
		poleB.setBounds(405,630, 100, 30);
		poleB.setFont(pole);
		this.add(poleB);
		poleC.setForeground(Color.white);
		poleC.setBounds(705,630, 100, 30);
		poleC.setFont(pole);
		this.add(poleC);
		
		begin = true;
		System.out.println("inside Tower: " + 5);
		init(4);
...
//				Dimension.i=0;
	...
	public class ImagePanel extends JPanel {
		...
		protected void paintComponent(Graphics g) {
			...
			g.drawImage(Assets.cave,0,0,900,700,null);
	    }
	 }
	...
	public void init(int level){
		...
		for(int i=0;i<noOfPeg;i++){
			...
			rect.setFrame (x-wr/2,585-i*20,wr,20);
			stack[0].push(rect);
